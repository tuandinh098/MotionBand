...
#define SENSOR_SERVICE_UUID     SYS_SERV_UUID
#define SENSOR_PERIOD_UUID      SYS_PERI_UUID

#define SENSOR_SERVICE          SYS_SERVICE
#define SENSOR_DATA_LEN         SYS_DATA_LEN
 ...
 */
bStatus_t Sys_registerAppCBs(sensorCBs_t *appCallbacks)
{
 ...
 * @return  bStatus_t
 */
bStatus_t Sys_setParameter(uint8_t param, uint8_t len, void *value)
{
 ...
 * @return  bStatus_t
 */
bStatus_t Sys_getParameter(uint8_t param, void *value)
{
  bStatus_t ret = SUCCESS;
